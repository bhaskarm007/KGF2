...
// Script to pause the webelement for particular period of time
...
public static void main(String[] args) {
	...
	driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
	 ...
	 WebElement sourceEle = driver.findElement(By.id("draggable"));
	  ...
	  action.clickAndHold(sourceEle).moveToElement(targetEle).pause(Duration.ofSeconds(5)).release().perform();
/*
